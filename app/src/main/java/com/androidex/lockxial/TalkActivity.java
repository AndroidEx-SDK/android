...
public class TalkActivity extends Activity{
    ...
    protected Messenger talkMessenger;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initScreen();
        initHandler();
        Intent intent = new Intent(TalkActivity.this,MainService.class);
    ...
    private void initHandler(){
        ...
        talkMessenger=new Messenger(handler);
    }
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Message message = Message.obtain();
            message.what = MainService.REGISTER_ACTIVITY_TALK;
            message.replyTo = talkMessenger;
            try {
